                ...
                switch (response.status) {
                    case 200:
                        ...
                        if (response.data.length == 0) {
                            $('#estudiante-table').append($('<tr><td colspan="7" class="td-center">No hay resultados que mostrar</td></tr>'));
                        }
                                ...
                                success: function (data) {
                                    ...
                                    switch (response.status) {
                                        case 200:
                                            ...
                                            $('#input-fechadenacimiento input').val(response.data.FechaDeNacimiento);
